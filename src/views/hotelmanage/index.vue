<template>
  <div class="app-container">
    ...
    <div class="main-box">
      <!--酒店列表盒子-->
      <div class="hotel_box" v-if="total > 0">
        <el-row :gutter="20" class="card_box">
          ...
          >
            <div class="card_info">
              <p v-if="item.hotelName.length <= 8">
                <span>酒店名称：</span>{{ hidetextFun(item.hotelName, 8) }}
              </p>
              <el-tooltip
                class="item"
                effect="light"
...
export default {
  ...
  methods: {
    fetchData() {
      this.searchdata._uid = Number(this.searchdata._uid);
